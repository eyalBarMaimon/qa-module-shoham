            ...
            <tr key={r._id || i} className={i % 2 === 0 ? 'bg-white' : 'bg-[#FAFAFA]'}>
              ...
              <td className="border border-[#999] px-2 py-1.5 text-center whitespace-nowrap">
                <div className="flex items-center justify-center gap-2">
                  <button onClick={() => setActiveFilter(r)} className="text-blue-600 text-xs hover:underline whitespace-nowrap">
                    עדכן / היסטוריה
                  </button>
                  <button onClick={() => setEditFilter(r)} title="עריכה"
                    className="text-gray-400 hover:text-blue-600 leading-none" style={{fontSize: '11px'}}>
                    ✏️
                  </button>
                  <button onClick={() => handleDeleteFilter(r)} title="מחק שורה"
