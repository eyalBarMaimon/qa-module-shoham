...
**גרסה:** 1.0.1 | **Live:** https://eyalbarmaimon.github.io/qa-module-shoham/
...
| מודול | תיאור |
|-------|--------|
| Dashboard | 6 כרטיסי סיכום + טבלת התראות |
| כלי מדידה (F-7.6.1) | 53 פריטים, כיול, היסטוריה |
| מערכות (F-7.6.1-1) | 13 מכונות לייזר |
